...
public class j2dot {
  ...
  j2dot() {
    try {
      fw = new FileWriter(dir + "text.txt");
      ...
      // Scanner
      // to read jdb output
      m_jdb_out = new Scanner(p_jdb.getInputStream()).useDelimiter("\\z|\\n");
  ...
  String jdb_getResponse() throws InterruptedException {
    Thread.sleep(50);
  ...
  // reads, returns jdb response
  String jdb_read() {
    String ret = "";
    while (true) {
      if (m_jdb_out.hasNext()) {
        String l = m_jdb_out.next();
        ret += l + "\n";

        if (l.matches("main\\[.*")) {
          break;
        }
        if (l.contains("application exited")) {
          System.out.println("exited");
          isFinished = true;
          break;
        }
  ...
  public List<String> getKnownVarsFromData(String data) {
  ...
  public String[] getAttributeListInOrder(String scheme) {
  ...
  public boolean isPrimitiveScheme(String scheme) {
  ...
  public String getPrimitiveValue(String objName) throws InterruptedException {
  ...
  public HashMap<String, String> getAttrValues(String objName) throws InterruptedException {
  ...
  public String getObjectIdsFromArray(String objName) throws InterruptedException {
  ...
  // get memory adress
  public String getObjectId(String objName) throws InterruptedException {
